...
class Insect(object):
    ...
    is_ant = False
    damage = 0
    #added watersafe class variable
    watersafe = False
...
class Bee(Insect):
    ...
    name = 'Bee'
    damage = 1
    #added another class variable for watersafe
    watersafe = True
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        u = self.place 
        random_bee = None
        # hive's exit and entrance is None, name is 'Hive'
        while random_bee == None:
            if u == hive:
                return None
            random_bee = random_or_none(u.bees)
            u = u.entrance
        return random_bee
        # END Problem 3B
